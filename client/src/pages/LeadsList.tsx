...
export function LeadsListPage() {
  ...
  const params = { search, status: status || undefined, priority: priority || undefined, ownerId: ownerId || undefined, serviceId: serviceId || undefined, sourceId: sourceId || undefined, state: state || undefined, unassigned: unassigned || undefined, sortBy, sortDir: sortDir as "asc" | "desc", page, pageSize };
  ...
  function resetFilters() {
    setSearch(""); setStatus(""); setPriority(""); setOwnerId(""); setServiceId(""); setSourceId(""); setState(""); setUnassigned(false); setSort("createdAt:desc"); setPage(1);
  }
